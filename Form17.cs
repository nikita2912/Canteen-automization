...
namespace Login
{
    public partial class Form17 : Form
    {
        ...
        {
            cmd = new MySqlCommand("insert into cook(c_id,c_name,address,cont_no,u_name,password,salary,date) values(?a,?b,?c,?d,?e,?f,?g,?h)", con);
        ...
        private void Form17_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            int i = 0;
            cmd = new MySqlCommand("select max(c_id) from cook", con);
