...
namespace Login
{
    public partial class Form20 : Form
    {
        ...
        {
            cmd1 = new MySqlCommand("delete from supplier where s_id=?b", con);
        ...
        private void Form20_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                da = new MySqlDataAdapter("select * from supplier", con);
                da.Fill(ds);
        ...
        {
            cmd = new MySqlCommand("select * from supplier where s_name=?a", con);
